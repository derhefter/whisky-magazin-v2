...
def _card_link(title: str, subtitle: str, url: str, tags: list = None) -> str:
    tags_html = _tag_badges(tags or [])
    return f"""
    <a href="{url}" style="display:block;background:var(--bg-elevated);border:1px solid var(--border);border-radius:var(--radius-sm);padding:20px 24px;text-decoration:none;color:inherit;transition:box-shadow 0.2s;" onmouseover="this.style.boxShadow='var(--shadow-hover)'" onmouseout="this.style.boxShadow=''">
...
def build_glossary_index(data: dict, config: dict) -> str:
    ...
    <!-- Statistik-Band -->
    <div style="background:var(--accent-amber);padding:20px 24px;">
